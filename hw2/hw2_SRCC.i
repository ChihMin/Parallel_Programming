...
# 178 "/usr/include/x86_64-linux-gnu/c++/4.8/bits/c++config.h" 3
namespace std
{
...
# 420 "/usr/include/x86_64-linux-gnu/c++/4.8/bits/c++config.h" 3
...
# 421 "/usr/include/x86_64-linux-gnu/c++/4.8/bits/c++config.h" 2 3


# 1 "/usr/include/x86_64-linux-gnu/c++/4.8/bits/cpu_defines.h" 1 3
# 424 "/usr/include/x86_64-linux-gnu/c++/4.8/bits/c++config.h" 2 3
...
int main(int argc, char *argv[]) {
  ...
  for (int i = 0; i < NUM_THREADS; i++) {
    pthread_create(&threads[i], __null, Thread, (void *)i);
  }
